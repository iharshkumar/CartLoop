        ...
        <section className='py-8 !pb-0'>
            ...
            <div className='w-full bg-white py-3 mt-4' style={{ padding: '15px' }}>
                <div className='container flex flex-col lg:flex-row gap-4 lg:gap-6'>
                    <div className='sidebarWrapper hidden lg:block w-[20%] '>
                        <SideBar
                    ...
                    <div className='rightContent w-full lg:w-[80%] !py-3'>
                        ...
                        <div className='!w-full !mb-4 !rounded-xl flex flex-col sm:flex-row items-center justify-between !p-3 sticky top-[80px] z-[50] shadow-sm border border-gray-100 bg-white/80 backdrop-blur-md transition-all gap-4' style={{ minHeight: '60px' }}>
                            <div className='col1 flex items-center gap-2 itemViewActions w-full sm:w-auto justify-between sm:justify-start'>
                                ...
                                <h6 className='whitespace-nowrap m-0 text-[13px] font-[400] text-gray-500'> {productsData?.length} products</h6>
                            </div>

                            <div className='col2 w-full sm:w-auto flex items-center justify-between sm:justify-end gap-2 border-t sm:border-t-0 pt-3 sm:pt-0'>
                                <span className='whitespace-nowrap m-0 text-[13px] font-[400] text-gray-400'>Sort By</span>
                                <Button
                                    ...
                                    className='!bg-gray-50 !text-[12px] !text-[#000] !text-capitalise border border-gray-200 !px-4 !rounded-full !h-[35px]'
                                >
                                    {selectedSortVal}
                                </Button>
            ...
            >
                <div className="flex justify-between items-center !p-4 border-b border-gray-200">
                    ...
                    <Button onClick={() => setIsFilterOpen(false)} className="!min-w-[40px] !w-[40px] !h-[40px] !rounded-full text-black">
                        <MdCancel className='!text-black-500 !text-[30px] !m-0' />
                    </Button>
                </div>
