...
const BlogDetails = () => {
    ...
    useEffect(() => {
        ...
        fetchDataFromApi(`/api/blog/${id}`).then((res) => {
            if (res?.error === false) {
                setBlogData(res?.blog || res?.data);
            }
            setLoading(false);
        });

        // Fetch all blogs to show "More Stories"
                    ...
                    blogData && (
                        <div className="featuredBlog !mb-24 animate-fade-in bg-white rounded-[32px] !p-8 md:!p-14 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-gray-50">
                            ...
                            <div className="imageContainer flex justify-center !mb-14">
                                <div className="imageWrapper w-full md:w-[85%] lg:w-[75%] overflow-hidden rounded-3xl shadow-2xl relative">
                                    <img
                                        ...
                                        className="w-full object-cover max-h-[650px] transition-transform duration-700 hover:scale-[1.02]"
                                        alt={blogData?.title}
                                    />
                            ...
                            <div className="blogContent flex justify-center w-full">
                                <div
                                    className="editorial-text !text-center text-[19px] leading-[1.85] text-gray-700 font-serif space-y-6 w-full max-w-[850px]"
                        ...
                        <div className="otherBlogsSection">
                            <div className="flex items-end justify-between !px-2">
                                <div className="leftSec text-left">
                                    <h3 className="text-[28px] font-[800] text-gray-900 tracking-tight line-[1]">Related Stories</h3>
                                </div>
                            </div>
